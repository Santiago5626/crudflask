...
def actualizar(codigo):
    try:
        print("ID recibido para actualizar:", codigo)  # <-- Verificar que se recibe el ID correctamente
        ...
        return jsonify({'mensaje': 'Registro actualizado exitosamente' if x > 0 else 'No se encontró el registro'})
